...
moosh category-create -p 6 -v 1 "Primaria"
...
moosh course-restore /init-scripts/mbzs/10_ceip.mbz 7
...
moosh course-restore /init-scripts/mbzs/13_ceip.mbz 7
...
moosh course-restore /init-scripts/mbzs/14_ceip.mbz 7
...
moosh course-restore /init-scripts/mbzs/19_ceip.mbz 7
...
moosh course-restore /init-scripts/mbzs/10_ceip.mbz 8
...
moosh course-restore /init-scripts/mbzs/13_ceip.mbz 8
...
moosh course-restore /init-scripts/mbzs/14_ceip.mbz 8
...
moosh course-restore /init-scripts/mbzs/19_ceip.mbz 8
...
moosh course-restore /init-scripts/mbzs/10_ceip.mbz 9
...
moosh course-restore /init-scripts/mbzs/13_ceip.mbz 9
...
moosh course-restore /init-scripts/mbzs/14_ceip.mbz 9
...
moosh course-restore /init-scripts/mbzs/19_ceip.mbz 9
...
moosh course-restore /init-scripts/mbzs/10_ceip.mbz 10
...
moosh course-restore /init-scripts/mbzs/13_ceip.mbz 10
...
moosh course-restore /init-scripts/mbzs/14_ceip.mbz 10
...
moosh course-restore /init-scripts/mbzs/19_ceip.mbz 10
...
moosh course-restore /init-scripts/mbzs/10_ceip.mbz 11
...
moosh course-restore /init-scripts/mbzs/10_ceip.mbz 12
...
moosh course-restore /init-scripts/mbzs/13_ceip.mbz 12
...
moosh course-restore /init-scripts/mbzs/14_ceip.mbz 12
...
moosh course-restore /init-scripts/mbzs/19_ceip.mbz 12
